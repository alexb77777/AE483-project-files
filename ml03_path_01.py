...
drone_client.move(0.0, 0.2, 0.5, 0.0, 1.0)

drone_client.move_smooth([0.0, 0.2, 0.5], [1.0, 0.2, 0.5], 0.0, 0.20)

drone_client.move(1.0, 0.3, 0.5, 0.0, 1.0)

drone_client.move_smooth([1.0, 0.3, 0.5], [0.0, 0.3, 0.5], 0.0, 0.20)

drone_client.move(0.0, 0.4, 0.5, 0.0, 1.0)

drone_client.move_smooth([0.0, 0.4, 0.5], [1.0, 0.4, 0.5], 0.0, 0.20)

drone_client.move(1.0, 0.5, 0.5, 0.0, 1.0)

drone_client.move_smooth([1.0, 0.5, 0.5], [0.0, 0.5, 0.5], 0.0, 0.20)

drone_client.move(0.0, 0.6, 0.5, 0.0, 1.0)

drone_client.move_smooth([0.0, 0.6, 0.5], [1.0, 0.6, 0.5], 0.0, 0.20)

drone_client.move(1.0, 0.7, 0.5, 0.0, 1.0)

drone_client.move_smooth([1.0, 0.7, 0.5], [0.0, 0.7, 0.5], 0.0, 0.20)

drone_client.move(0.0, 0.8, 0.5, 0.0, 1.0)

drone_client.move_smooth([0.0, 0.8, 0.5], [1.0, 0.8, 0.5], 0.0, 0.20)

drone_client.move(1.0, 0.9, 0.5, 0.0, 1.0)

drone_client.move_smooth([1.0, 0.9, 0.5], [0.0, 0.9, 0.5], 0.0, 0.20)

drone_client.move(0.0, 1.0, 0.5, 0.0, 1.0)

drone_client.move_smooth([0.0, 1.0, 0.5], [1.0, 1.0, 0.5], 0.0, 0.20)
