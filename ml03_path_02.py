...
drone_client.move_smooth([0.0, 0.1, 0.5], [0.0, 1.0, 0.5], 0.0, 0.20)

drone_client.move(0.1, 1.0, 0.5, 0.0, 1.0)

drone_client.move_smooth([0.1, 1.0, 0.5], [0.1, 0.2, 0.5], 0.0, 0.20)

drone_client.move_smooth([0.1, 0.2, 0.5], [1.0, 0.2, 0.5], 0.0, 0.20)

drone_client.move(1.0, 0.3, 0.5, 0.0, 1.0)

drone_client.move_smooth([1.0, 0.3, 0.5], [0.2, 0.3, 0.5], 0.0, 0.20)

drone_client.move_smooth([0.2, 0.3, 0.5], [0.2, 1.0, 0.5], 0.0, 0.20)

drone_client.move(0.3, 1.0, 0.5, 0.0, 1.0)

drone_client.move_smooth([0.3, 1.0, 0.5], [0.3, 0.4, 0.5], 0.0, 0.20)

drone_client.move_smooth([0.3, 0.4, 0.5], [1.0, 0.4, 0.5], 0.0, 0.20)

drone_client.move(1.0, 0.5, 0.5, 0.0, 1.0)

drone_client.move_smooth([1.0, 0.5, 0.5], [0.4, 0.5, 0.5], 0.0, 0.20)

drone_client.move_smooth([0.4, 0.5, 0.5], [0.4, 1.0, 0.5], 0.0, 0.20)

drone_client.move(0.5, 1.0, 0.5, 0.0, 1.0)

drone_client.move_smooth([0.5, 1.0, 0.5], [0.5, 0.6, 0.5], 0.0, 0.20)

drone_client.move_smooth([0.5, 0.6, 0.5], [1.0, 0.6, 0.5], 0.0, 0.20)

drone_client.move(1.0, 0.7, 0.5, 0.0, 1.0)

drone_client.move_smooth([1.0, 0.7, 0.5], [0.6, 0.7, 0.5], 0.0, 0.20)

drone_client.move_smooth([0.6, 0.7, 0.5], [0.6, 1.0, 0.5], 0.0, 0.20)

drone_client.move(0.7, 1.0, 0.5, 0.0, 1.0)

drone_client.move_smooth([0.7, 1.0, 0.5], [0.7, 0.8, 0.5], 0.0, 0.20)

drone_client.move_smooth([0.7, 0.8, 0.5], [1.0, 0.8, 0.5], 0.0, 0.20)

drone_client.move(1.0, 0.9, 0.5, 0.0, 1.0)

drone_client.move_smooth([1.0, 0.9, 0.5], [0.8, 0.9, 0.5], 0.0, 0.20)

drone_client.move_smooth([0.8, 0.9, 0.5], [0.8, 1.0, 0.5], 0.0, 0.20)

drone_client.move_smooth([0.8, 1.0, 0.5], [1.0, 1.0, 0.5], 0.0, 0.20)


# Graceful landing
drone_client.move_smooth([1.0, 1.0, 0.5], [1.0, 1.0, 0.20], 0.0, 0.20)
drone_client.move(1.0, 1.0, 0.20, 0.0, 1.0)
# Pause after landing
drone_client.stop(1.0)
